...
- [ ] 1.1 emit bounded-local cap + multi-reduction — files: compiler/emit/emit.ty — done when: local bounded push traps; two-reduction case refused by name or supported
