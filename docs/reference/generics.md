...
[the generics design note](../reference/generics.md).
...
2. **Generics do not touch the memory model.** Correctness rests on "no
   ...
   of [arrays-structs.md §8](arrays-slices.md): each instantiation is already
   ...
   ([§9 verdict](arrays-slices.md)) is preserved verbatim, because after
