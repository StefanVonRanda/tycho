...
> through to — shift `src/tychoc.c:6419@shift operators require integer operands`,
> modulo/bitwise `src/tychoc.c:6526@modulo / bitwise operators`.
...
> the one that requires a match: `src/tychoc.c:6494@rt`. Exhaustively pinned by
