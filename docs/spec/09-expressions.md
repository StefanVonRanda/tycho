...
> through to — shift `src/tychoc.c:6235@shift operators require integer operands`,
> modulo/bitwise `src/tychoc.c:6343@modulo / bitwise operators`.
...
> `src/tychoc.c:6103-6109`, result at `src/tychoc.c:6237@lt`. The bitwise arm is
