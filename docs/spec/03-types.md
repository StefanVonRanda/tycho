...
> `:12404-12407`. Fixtures: `tests/bounded.ty`, `tests/bounded_const_cap.ty`,
...
> the pointer-shaped arrays (`src/tychoc.c:11806-11904`, with `inline_arrc`/
> `needs_body_first` at `:11788-11794`; tychoc0's `comp_dep_types`
...
> value identity equality `:10096@identity equality`.
