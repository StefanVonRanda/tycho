...
> `:12552-12555`. Fixtures: `tests/bounded.ty`, `tests/bounded_const_cap.ty`,
...
> the pointer-shaped arrays (`src/tychoc.c:11954-12052`, with `inline_arrc`/
> `needs_body_first` at `:11936-11942`; tychoc0's `comp_dep_types`
...
> value identity equality `:10244@identity equality`.
