...
> `:1405-1445`; equality/ordering `:6245-6278`; newtype decl `parse_typedecl`
> `:4260-4279`.
...
> Rejections: slice `src/tychoc.c:5337-5338`, `pop` `:6017-6018`, `reserve`
> `:6516@reserve does not apply to a bounded`, over-long literal `:6223-6226`. The full-push trap is emitted at
> `:12020-12023`. Fixtures: `tests/bounded.ty`, `tests/bounded_const_cap.ty`,
...
> the pointer-shaped arrays (`src/tychoc.c:11430-11520`, with `inline_arrc`/
> `needs_body_first` at `:11412-11418`; tychoc0's `comp_dep_types`
...
> Provenance: `src/tychoc.c:6245-6278` (equality/ordering resolver); function-
> value identity equality `:9732@identity equality`.
