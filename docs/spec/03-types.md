...
> `:1444-1484`; equality/ordering `:6621-6654`; newtype decl `parse_typedecl`
> `:4470-4489`.
...
> Rejections: slice `src/tychoc.c:5659-5660`, `pop` `:6393-6394`, `reserve`
> `:6892@reserve does not apply to a bounded`, over-long literal `:6599-6602`. The full-push trap is emitted at
> `:12566-12569`. Fixtures: `tests/bounded.ty`, `tests/bounded_const_cap.ty`,
...
> the pointer-shaped arrays (`src/tychoc.c:11968-12066`, with `inline_arrc`/
> `needs_body_first` at `:11950-11956`; tychoc0's `comp_dep_types`
...
> Provenance: underlying restriction `src/tychoc.c:4482-4484`; its twin
...
> Provenance: `src/tychoc.c:6621-6654` (equality/ordering resolver); function-
> value identity equality `:10258@identity equality`.
