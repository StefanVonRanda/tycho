...
> `:1516-1556`; equality/ordering `:6909-6942`; newtype decl `parse_typedecl`
> `:4429-4448`.
...
> Provenance: `src/tychoc.c:6636-6669` (equality/ordering resolver); function-
> value identity equality `:10149@identity equality`.
