...
> `:1427-1467`; equality/ordering `:6369-6402`; newtype decl `parse_typedecl`
> `:4326-4345`.
...
> Provenance: dynamic `[T]` tests `void` alone (`src/tychoc.c:2449@elem`); the
...
> `src/tychoc.c:2327-2344@"bounded"` (capacity `:1956-1965`, element
...
> Rejections: slice `src/tychoc.c:5418-5419`, `pop` `:6141-6142`, `reserve`
> `:6640@reserve does not apply to a bounded`, over-long literal `:6347-6350`. The full-push trap is emitted at
> `:12213-12216`. Fixtures: `tests/bounded.ty`, `tests/bounded_const_cap.ty`,
...
> the pointer-shaped arrays (`src/tychoc.c:11615-11713`, with `inline_arrc`/
> `needs_body_first` at `:11597-11603`; tychoc0's `comp_dep_types`
...
> Provenance: underlying restriction `src/tychoc.c:4338-4340`; its twin
...
> Provenance: `src/tychoc.c:6369-6402` (equality/ordering resolver); function-
> value identity equality `:9917@identity equality`.
