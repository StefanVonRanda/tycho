...
> `:1516-1556`; equality/ordering `:6878-6911`; newtype decl `parse_typedecl`
> `:4412-4431`.
...
> Provenance: `src/tychoc.c:6605-6638` (equality/ordering resolver); function-
> value identity equality `:10088@identity equality`.
