...
> Provenance: scalar tags `src/tychoc.c:701-722`; C lowering `c_type`
> `:1390-1430`; equality/ordering `:6721-6754`; newtype decl `parse_typedecl`
> `:4267-4286`.
...
> Provenance: dynamic `[T]` tests `void` alone (`src/tychoc.c:2409@elem`); the
> fixed forms test both (`src/tychoc.c:2072-2073`), as does `bounded[N]T`
> (`src/tychoc.c:1963-1964`). Detailed in
...
> Provenance: `src/tychoc.c:6555-6588` (equality/ordering resolver); function-
> value identity equality `:10022@identity equality`.
