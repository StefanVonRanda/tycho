...
> `:1405-1445`; equality/ordering `:6266-6299`; newtype decl `parse_typedecl`
> `:4260-4279`.
...
> Rejections: slice `src/tychoc.c:5337-5338`, `pop` `:6038-6039`, `reserve`
> `:6537@reserve does not apply to a bounded`, over-long literal `:6244-6247`. The full-push trap is emitted at
> `:12041-12044`. Fixtures: `tests/bounded.ty`, `tests/bounded_const_cap.ty`,
...
> the pointer-shaped arrays (`src/tychoc.c:11451-11541`, with `inline_arrc`/
> `needs_body_first` at `:11433-11439`; tychoc0's `comp_dep_types`
...
> Provenance: `src/tychoc.c:6266-6299` (equality/ordering resolver); function-
> value identity equality `:9753@identity equality`.
