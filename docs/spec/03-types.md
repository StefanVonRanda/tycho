...
> `:1516-1556`; equality/ordering `:6859-6892`; newtype decl `parse_typedecl`
> `:4393-4412`.
...
> Provenance: dynamic `[T]` tests `void` alone (`src/tychoc.c:2434@elem`); the
...
> Provenance: `src/tychoc.c:6586-6619` (equality/ordering resolver); function-
> value identity equality `:10053@identity equality`.
