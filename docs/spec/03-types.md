...
> `:1438-1478`; equality/ordering `:6564-6597`; newtype decl `parse_typedecl`
> `:4425-4444`.
...
> Rejections: slice `src/tychoc.c:5608-5609`, `pop` `:6336-6337`, `reserve`
> `:6835@reserve does not apply to a bounded`, over-long literal `:6542-6545`. The full-push trap is emitted at
> `:12483-12486`. Fixtures: `tests/bounded.ty`, `tests/bounded_const_cap.ty`,
...
> the pointer-shaped arrays (`src/tychoc.c:11885-11983`, with `inline_arrc`/
> `needs_body_first` at `:11867-11873`; tychoc0's `comp_dep_types`
...
> Provenance: `src/tychoc.c:6564-6597` (equality/ordering resolver); function-
> value identity equality `:10175@identity equality`.
