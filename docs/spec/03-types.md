...
> `:1444-1484`; equality/ordering `:6595-6628`; newtype decl `parse_typedecl`
> `:4444-4463`.
...
> Rejections: slice `src/tychoc.c:5633-5634`, `pop` `:6367-6368`, `reserve`
> `:6866@reserve does not apply to a bounded`, over-long literal `:6573-6576`. The full-push trap is emitted at
> `:12533-12536`. Fixtures: `tests/bounded.ty`, `tests/bounded_const_cap.ty`,
...
> the pointer-shaped arrays (`src/tychoc.c:11935-12033`, with `inline_arrc`/
> `needs_body_first` at `:11917-11923`; tychoc0's `comp_dep_types`
...
> Provenance: underlying restriction `src/tychoc.c:4456-4458`; its twin
...
> Provenance: `src/tychoc.c:6595-6628` (equality/ordering resolver); function-
> value identity equality `:10225@identity equality`.
