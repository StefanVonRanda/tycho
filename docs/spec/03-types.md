...
> `src/tychoc.c:2094-2111@"bounded"` (capacity `:1866-1875`, element
...
> `:6151@reserve does not apply to a bounded`, over-long literal `:6023-6026`. The full-push trap is emitted at
...
> value identity equality `:9253@identity equality`.
