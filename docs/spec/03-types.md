...
> `:1438-1478`; equality/ordering `:6500-6533`; newtype decl `parse_typedecl`
> `:4384-4403`.
...
> Rejections: slice `src/tychoc.c:5547-5548`, `pop` `:6272-6273`, `reserve`
> `:6771@reserve does not apply to a bounded`, over-long literal `:6478-6481`. The full-push trap is emitted at
> `:12385-12388`. Fixtures: `tests/bounded.ty`, `tests/bounded_const_cap.ty`,
...
> the pointer-shaped arrays (`src/tychoc.c:11787-11885`, with `inline_arrc`/
> `needs_body_first` at `:11769-11775`; tychoc0's `comp_dep_types`
...
> Provenance: underlying restriction `src/tychoc.c:4396-4398`; its twin
...
> Provenance: `src/tychoc.c:6500-6533` (equality/ordering resolver); function-
> value identity equality `:10077@identity equality`.
