...
> `:1438-1478`; equality/ordering `:6539-6572`; newtype decl `parse_typedecl`
> `:4423-4442`.
...
> Rejections: slice `src/tychoc.c:5586-5587`, `pop` `:6311-6312`, `reserve`
> `:6810@reserve does not apply to a bounded`, over-long literal `:6517-6520`. The full-push trap is emitted at
> `:12458-12461`. Fixtures: `tests/bounded.ty`, `tests/bounded_const_cap.ty`,
...
> the pointer-shaped arrays (`src/tychoc.c:11860-11958`, with `inline_arrc`/
> `needs_body_first` at `:11842-11848`; tychoc0's `comp_dep_types`
...
> Provenance: underlying restriction `src/tychoc.c:4435-4437`; its twin
...
> Provenance: `src/tychoc.c:6539-6572` (equality/ordering resolver); function-
> value identity equality `:10150@identity equality`.
