...
> `:1444-1484`; equality/ordering `:6610-6643`; newtype decl `parse_typedecl`
> `:4459-4478`.
...
> Provenance: dynamic `[T]` tests `void` alone (`src/tychoc.c:2498@elem`); the
...
> Rejections: slice `src/tychoc.c:5648-5649`, `pop` `:6382-6383`, `reserve`
> `:6881@reserve does not apply to a bounded`, over-long literal `:6588-6591`. The full-push trap is emitted at
> `:12555-12558`. Fixtures: `tests/bounded.ty`, `tests/bounded_const_cap.ty`,
...
> the pointer-shaped arrays (`src/tychoc.c:11957-12055`, with `inline_arrc`/
> `needs_body_first` at `:11939-11945`; tychoc0's `comp_dep_types`
...
> Provenance: underlying restriction `src/tychoc.c:4471-4473`; its twin
...
> Provenance: `src/tychoc.c:6610-6643` (equality/ordering resolver); function-
> value identity equality `:10247@identity equality`.
