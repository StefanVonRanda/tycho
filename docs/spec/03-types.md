...
> `:1438-1478`; equality/ordering `:6482-6515`; newtype decl `parse_typedecl`
> `:4366-4385`.
...
> Rejections: slice `src/tychoc.c:5529-5530`, `pop` `:6254-6255`, `reserve`
> `:6753@reserve does not apply to a bounded`, over-long literal `:6460-6463`. The full-push trap is emitted at
> `:12326-12329`. Fixtures: `tests/bounded.ty`, `tests/bounded_const_cap.ty`,
...
> the pointer-shaped arrays (`src/tychoc.c:11728-11826`, with `inline_arrc`/
> `needs_body_first` at `:11710-11716`; tychoc0's `comp_dep_types`
...
> Provenance: underlying restriction `src/tychoc.c:4378-4380`; its twin
...
> Provenance: `src/tychoc.c:6482-6515` (equality/ordering resolver); function-
> value identity equality `:10030@identity equality`.
