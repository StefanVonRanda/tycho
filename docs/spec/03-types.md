...
> Provenance: dynamic `[T]` tests `void` alone (`src/tychoc.c:2661@elem`); the
> fixed forms test both (`src/tychoc.c:2230-2231`), as does `bounded[N]T`
> (`src/tychoc.c:2121-2122`). Detailed in
