...
> `:4697@.name="to_char"`, their shared codegen `:9190-9192`;
...
> `:5607-5615`; `recv` `:5616-5621`; `close` `:5622-5632`; `ncpu` `Sig` `:4696@.name="ncpu"`;
...
> Provenance: `die` `Sig` `src/tychoc.c:4698@.name="die"`, codegen `:9150-9151`; `exit` `Sig`
