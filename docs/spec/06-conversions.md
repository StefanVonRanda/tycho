...
> Provenance: conversion builtins `src/tychoc.c:6081-6137`; literal adaptation
> in the binary-op and checking paths `:6467-6481`,`:6740-6751`, and its array-literal element path `:6720-6729`.
