...
> Provenance: conversion builtins `src/tychoc.c:6201-6257`; literal adaptation
> in the binary-op and checking paths `:6874-6888`,`:7166-7177`, and its array-literal element path `:7146-7155`.
