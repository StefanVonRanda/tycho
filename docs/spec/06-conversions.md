...
> Provenance: conversion builtins `src/tychoc.c:5871-5927`; literal adaptation
> in the binary-op and checking paths `:6251-6265`,`:6524-6535`, and its array-literal element path `:6504-6513`.
