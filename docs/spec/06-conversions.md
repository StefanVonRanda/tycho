...
> Provenance: conversion builtins `src/tychoc.c:6220-6276`; literal adaptation
> in the binary-op and checking paths `:6606-6620`,`:6879-6890`, and its array-literal element path `:6859-6868`.
