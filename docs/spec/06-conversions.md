...
> Provenance: conversion builtins `src/tychoc.c:5839-5895`; literal adaptation
> in the binary-op and checking paths `:6234-6248`,`:6507-6518`, and its array-literal element path `:6487-6496`.
