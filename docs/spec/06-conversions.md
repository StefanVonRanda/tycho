...
> Provenance: conversion builtins `src/tychoc.c:6067-6123`; literal adaptation
> in the binary-op and checking paths `:6453-6467`,`:6726-6737`, and its array-literal element path `:6706-6715`.
