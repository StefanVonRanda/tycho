...
> Provenance: conversion builtins `src/tychoc.c:6190-6246`; literal adaptation
> in the binary-op and checking paths `:6863-6877`,`:7155-7166`, and its array-literal element path `:7135-7144`.
