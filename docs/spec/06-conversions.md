...
> Provenance: conversion builtins `src/tychoc.c:6118-6174`; literal adaptation
> in the binary-op and checking paths `:6504-6518`,`:6777-6788`, and its array-literal element path `:6757-6766`.
