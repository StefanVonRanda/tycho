...
> Provenance: conversion builtins `src/tychoc.c:6289-6345`; literal adaptation
> in the binary-op and checking paths `:6971-6985`,`:7271-7283`, and its array-literal element path `:7251-7260`.
