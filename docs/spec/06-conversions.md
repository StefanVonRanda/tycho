...
> Provenance: conversion builtins `src/tychoc.c:6002-6058`; literal adaptation
> in the binary-op and checking paths `:6566-6580`,`:6839-6850`, and its array-literal element path `:6819-6828`.
