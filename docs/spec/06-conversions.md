...
> Provenance: conversion builtins `src/tychoc.c:5909-5965`; literal adaptation
> in the binary-op and checking paths `:6295-6309`,`:6568-6579`, and its array-literal element path `:6548-6557`.
