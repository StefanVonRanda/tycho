...
> Provenance: conversion builtins `src/tychoc.c:5842-5898`; literal adaptation
> in the binary-op and checking paths `:6222-6236`,`:6495-6506`, and its array-literal element path `:6475-6484`.
