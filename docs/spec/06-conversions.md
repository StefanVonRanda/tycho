...
> Provenance: conversion builtins `src/tychoc.c:6232-6288`; literal adaptation
> in the binary-op and checking paths `:6625-6639`,`:6898-6909`, and its array-literal element path `:6878-6887`.
