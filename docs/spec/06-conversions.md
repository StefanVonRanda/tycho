...
> Provenance: conversion builtins `src/tychoc.c:5766-5822`; literal adaptation
> in the binary-op and checking paths `:6146-6160`,`:6419-6430`, and its array-literal element path `:6399-6408`.
