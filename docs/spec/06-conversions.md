...
> Provenance: conversion builtins `src/tychoc.c:6171-6227`; literal adaptation
> in the binary-op and checking paths `:6844-6858`,`:7136-7147`, and its array-literal element path `:7116-7125`.
