...
> Provenance: conversion builtins `src/tychoc.c:5786-5842`; literal adaptation
> in the binary-op and checking paths `:6166-6180`,`:6439-6450`, and its array-literal element path `:6419-6428`.
