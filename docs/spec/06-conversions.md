...
> Provenance: conversion builtins `src/tychoc.c:6812-6889`; literal adaptation
> in the binary-op and checking paths `:7526-7540`,`:7830-7842`, and its array-literal element path `:7810-7819`.
