...
> Provenance: conversion builtins `src/tychoc.c:6294-6350`; literal adaptation
> in the binary-op and checking paths `:6976-6990`,`:7276-7288`, and its array-literal element path `:7256-7265`.
