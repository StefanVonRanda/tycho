...
> Provenance: conversion builtins `src/tychoc.c:6351-6407`; literal adaptation
> in the binary-op and checking paths `:7033-7047`,`:7333-7345`, and its array-literal element path `:7313-7322`.
