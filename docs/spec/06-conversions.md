...
> Provenance: conversion builtins `src/tychoc.c:5877-5933`; literal adaptation
> in the binary-op and checking paths `:6263-6277`,`:6536-6547`, and its array-literal element path `:6516-6525`.
