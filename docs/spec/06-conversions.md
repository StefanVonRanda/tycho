...
> Provenance: conversion builtins `src/tychoc.c:6750-6827`; literal adaptation
> in the binary-op and checking paths `:7464-7478`,`:7764-7776`, and its array-literal element path `:7744-7753`.
