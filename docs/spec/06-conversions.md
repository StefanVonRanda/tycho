...
> Provenance: conversion builtins `src/tychoc.c:6247-6303`; literal adaptation
> in the binary-op and checking paths `:6929-6943`,`:7229-7240`, and its array-literal element path `:7209-7218`.
