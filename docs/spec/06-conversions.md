...
> Provenance: conversion builtins `src/tychoc.c:6653-6709`; literal adaptation
> in the binary-op and checking paths `:7367-7381`,`:7667-7679`, and its array-literal element path `:7647-7656`.
