...
> Provenance: conversion builtins `src/tychoc.c:6209-6265`; literal adaptation
> in the binary-op and checking paths `:6595-6609`,`:6868-6879`, and its array-literal element path `:6848-6857`.
