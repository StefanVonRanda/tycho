...
> Provenance: conversion builtins `src/tychoc.c:5958-6014`; literal adaptation
> in the binary-op and checking paths `:6522-6536`,`:6795-6806`, and its array-literal element path `:6775-6784`.
