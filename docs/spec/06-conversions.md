...
> Provenance: conversion builtins `src/tychoc.c:6411-6467`; literal adaptation
> in the binary-op and checking paths `:7121-7135`,`:7421-7433`, and its array-literal element path `:7401-7410`.
