...
> Provenance: conversion builtins `src/tychoc.c:6052-6108`; literal adaptation
> in the binary-op and checking paths `:6438-6452`,`:6711-6722`, and its array-literal element path `:6691-6700`.
