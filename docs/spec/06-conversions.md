...
> Provenance: conversion builtins `src/tychoc.c:6374-6430`; literal adaptation
> in the binary-op and checking paths `:7084-7098`,`:7384-7396`, and its array-literal element path `:7364-7373`.
