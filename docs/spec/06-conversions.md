...
> Provenance: conversion builtins `src/tychoc.c:5850-5906`; literal adaptation
> in the binary-op and checking paths `:6230-6244`,`:6503-6514`, and its array-literal element path `:6483-6492`.
