...
> Provenance: conversion builtins `src/tychoc.c:5740-5796`; literal adaptation
> in the binary-op and checking paths `:6120-6134`,`:6393-6404`, and its array-literal element path `:6373-6382`.
