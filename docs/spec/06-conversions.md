...
> Provenance: conversion builtins `src/tychoc.c:6668-6745`; literal adaptation
> in the binary-op and checking paths `:7403-7417`,`:7703-7715`, and its array-literal element path `:7683-7692`.
