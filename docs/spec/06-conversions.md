...
> Provenance: conversion builtins `src/tychoc.c:5890-5946`; literal adaptation
> in the binary-op and checking paths `:6276-6290`,`:6549-6560`, and its array-literal element path `:6529-6538`.
