...
> Provenance: conversion builtins `src/tychoc.c:5902-5958`; literal adaptation
> in the binary-op and checking paths `:6288-6302`,`:6561-6572`, and its array-literal element path `:6541-6550`.
