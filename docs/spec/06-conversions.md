...
> Provenance: conversion builtins `src/tychoc.c:5968-6024`; literal adaptation
> in the binary-op and checking paths `:6354-6368`,`:6627-6638`, and its array-literal element path `:6607-6616`.
