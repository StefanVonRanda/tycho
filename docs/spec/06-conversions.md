...
> Provenance: conversion builtins `src/tychoc.c:6319-6375`; literal adaptation
> in the binary-op and checking paths `:7001-7015`,`:7301-7313`, and its array-literal element path `:7281-7290`.
