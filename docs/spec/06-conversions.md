...
> Provenance: conversion builtins `src/tychoc.c:6796-6873`; literal adaptation
> in the binary-op and checking paths `:7510-7524`,`:7814-7826`, and its array-literal element path `:7794-7803`.
