...
> Provenance: conversion builtins `src/tychoc.c:5752-5808`; literal adaptation
> in the binary-op and checking paths `:6132-6146`,`:6405-6416`, and its array-literal element path `:6385-6394`.
