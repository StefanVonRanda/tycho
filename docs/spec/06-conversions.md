...
> Provenance: conversion builtins `src/tychoc.c:6163-6219`; literal adaptation
> in the binary-op and checking paths `:6549-6563`,`:6822-6833`, and its array-literal element path `:6802-6811`.
