...
> Provenance: conversion builtins `src/tychoc.c:5690-5746`; literal adaptation
> in the binary-op and checking paths `:6070-6084`,`:6343-6354`, and its array-literal element path `:6323-6332`.
