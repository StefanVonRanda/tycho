...
> Provenance: conversion builtins `src/tychoc.c:6099-6155`; literal adaptation
> in the binary-op and checking paths `:6485-6499`,`:6758-6769`, and its array-literal element path `:6738-6747`.
