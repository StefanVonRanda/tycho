...
> Provenance: conversion builtins `src/tychoc.c:5787-5843`; literal adaptation
> in the binary-op and checking paths `:6167-6181`,`:6440-6451`, and its array-literal element path `:6420-6429`.
