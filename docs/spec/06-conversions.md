...
> Provenance: conversion builtins `src/tychoc.c:6610-6666`; literal adaptation
> in the binary-op and checking paths `:7324-7338`,`:7624-7636`, and its array-literal element path `:7604-7613`.
