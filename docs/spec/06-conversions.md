...
> Provenance: conversion builtins `src/tychoc.c:5814-5870`; literal adaptation
> in the binary-op and checking paths `:6194-6208`,`:6467-6478`, and its array-literal element path `:6447-6456`.
