...
> Provenance: conversion builtins `src/tychoc.c:6420-6476`; literal adaptation
> in the binary-op and checking paths `:7134-7148`,`:7434-7446`, and its array-literal element path `:7414-7423`.
