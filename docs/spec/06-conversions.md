...
> Provenance: conversion builtins `src/tychoc.c:5861-5917`; literal adaptation
> in the binary-op and checking paths `:6259-6273`,`:6532-6543`, and its array-literal element path `:6512-6521`.
