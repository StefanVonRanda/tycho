...
> Provenance: conversion builtins `src/tychoc.c:6242-6298`; literal adaptation
> in the binary-op and checking paths `:6635-6649`,`:6908-6919`, and its array-literal element path `:6888-6897`.
