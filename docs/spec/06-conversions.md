...
> Provenance: conversion builtins `src/tychoc.c:6183-6239`; literal adaptation
> in the binary-op and checking paths `:6856-6870`,`:7148-7159`, and its array-literal element path `:7128-7137`.
