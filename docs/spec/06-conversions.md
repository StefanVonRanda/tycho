...
> Provenance: conversion builtins `src/tychoc.c:5880-5936`; literal adaptation
> in the binary-op and checking paths `:6266-6280`,`:6539-6550`, and its array-literal element path `:6519-6528`.
