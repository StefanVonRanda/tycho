...
> Provenance: conversion builtins `src/tychoc.c:5676-5732`; literal adaptation
> in the binary-op and checking paths `:6056-6070`,`:6329-6340`, and its array-literal element path `:6309-6318`.
