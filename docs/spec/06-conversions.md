...
> Provenance: conversion builtins `src/tychoc.c:6140-6196`; literal adaptation
> in the binary-op and checking paths `:6706-6720`,`:6990-7001`, and its array-literal element path `:6970-6979`.
