...
> Provenance: conversion builtins `src/tychoc.c:6169-6225`; literal adaptation
> in the binary-op and checking paths `:6555-6569`,`:6828-6839`, and its array-literal element path `:6808-6817`.
