...
> Provenance: conversion builtins `src/tychoc.c:6181-6237`; literal adaptation
> in the binary-op and checking paths `:6567-6581`,`:6840-6851`, and its array-literal element path `:6820-6829`.
