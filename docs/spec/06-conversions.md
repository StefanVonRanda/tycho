...
> Provenance: conversion builtins `src/tychoc.c:5924-5980`; literal adaptation
> in the binary-op and checking paths `:6310-6324`,`:6583-6594`, and its array-literal element path `:6563-6572`.
