...
> Provenance: conversion builtins `src/tychoc.c:5819-5875`; literal adaptation
> in the binary-op and checking paths `:6199-6213`,`:6472-6483`, and its array-literal element path `:6452-6461`.
