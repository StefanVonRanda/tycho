...
> Provenance: conversion builtins `src/tychoc.c:6051-6107`; literal adaptation
> in the binary-op and checking paths `:6617-6631`,`:6901-6912`, and its array-literal element path `:6881-6890`.
