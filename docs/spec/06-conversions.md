...
> Provenance: conversion builtins `src/tychoc.c:5946-6002`; literal adaptation
> in the binary-op and checking paths `:6332-6346`,`:6605-6616`, and its array-literal element path `:6585-6594`.
