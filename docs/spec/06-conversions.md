...
> Provenance: conversion builtins `src/tychoc.c:6102-6158`; literal adaptation
> in the binary-op and checking paths `:6668-6682`,`:6952-6963`, and its array-literal element path `:6932-6941`.
