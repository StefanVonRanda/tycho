...
> Provenance: conversion builtins `src/tychoc.c:6194-6250`; literal adaptation
> in the binary-op and checking paths `:6580-6594`,`:6853-6864`, and its array-literal element path `:6833-6842`.
