...
> Provenance: conversion builtins `src/tychoc.c:6212-6268`; literal adaptation
> in the binary-op and checking paths `:6894-6908`,`:7194-7205`, and its array-literal element path `:7174-7183`.
