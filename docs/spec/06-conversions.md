...
> Provenance: conversion builtins `src/tychoc.c:6138-6194`; literal adaptation
> in the binary-op and checking paths `:6524-6538`,`:6797-6808`, and its array-literal element path `:6777-6786`.
