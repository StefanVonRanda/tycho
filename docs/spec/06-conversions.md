...
> Provenance: conversion builtins `src/tychoc.c:6068-6124`; literal adaptation
> in the binary-op and checking paths `:6634-6648`,`:6918-6929`, and its array-literal element path `:6898-6907`.
