...
> Provenance: conversion builtins `src/tychoc.c:6398-6454`; literal adaptation
> in the binary-op and checking paths `:7112-7126`,`:7412-7424`, and its array-literal element path `:7392-7401`.
