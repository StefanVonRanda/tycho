...
> Provenance: parser entry `src/tychoc.c:4550-4575` (`parse_program`); the
...
> Provenance: `parse_package_decl` `src/tychoc.c:4706@parse_package_decl`, `parse_import_decl` `:4713@parse_import_decl`, `parse_const`
> (`src/tychoc.c:4531-4548`).
...
> Provenance: `parse_fn`, `src/tychoc.c:3788-3898` (params `:3811-3836`,
> variadic-last `:3838-3840`, `where` `:3852-3890`).
...
> Provenance: `parse_extern_fn` (`src/tychoc.c:4038-4113`), `parse_subscript`
> (`:3918-3970`).
...
> Provenance: `parse_type_inner`, `src/tychoc.c:1960-2239`.
...
> Provenance: `parse_stmt`, `src/tychoc.c:3259-3739`; `ExprStmt` restriction
> `:3727-3734`; compound-assign hoist `:3221-3257`.
...
> Provenance: `parse_if` (`src/tychoc.c:3175@parse_if`), `parse_match`
> (`src/tychoc.c:3281@parse_match`, value form `src/tychoc.c:3406@parse_match`),
> `for`/`parallel` (`src/tychoc.c:3386-3597`; the three-clause header
> `src/tychoc.c:3430-3479`, `0..<N` `src/tychoc.c:3502-3527`, the `range`
> refusal `src/tychoc.c:3887@"range"`), `select` (`src/tychoc.c:3340-3376`),
> value-control routing (`src/tychoc.c:3660@parse_value_ctrl`,
> `src/tychoc.c:3980@parse_value_ctrl`, `src/tychoc.c:3994@parse_value_ctrl`,
> `src/tychoc.c:3980@parse_value_ctrl`, `src/tychoc.c:4025@parse_value_ctrl`).
...
> Provenance: precedence chain `src/tychoc.c:2755-2823`; postfix `:2615-2704`;
> `parse_primary` `:2324-2612`; unary `:2712-2718`.
...
> `parse_expr`, `src/tychoc.c:2755-2823`; postfix/unary `:2615-2718`.
