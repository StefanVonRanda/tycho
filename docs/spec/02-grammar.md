...
> Provenance: `parse_package_decl` `src/tychoc.c:4449@parse_package_decl`, `parse_import_decl` `:4456@parse_import_decl`, `parse_const`
...
> Provenance: `parse_if` (`src/tychoc.c:2945@parse_if`), `parse_match`
> (`src/tychoc.c:3051@parse_match`, value form `src/tychoc.c:3176@parse_match`),
> `for`/`parallel` (`src/tychoc.c:3235-3446`; the three-clause header
> `src/tychoc.c:3279-3328`, `0..<N` `src/tychoc.c:3351-3376`, the `range`
> refusal `src/tychoc.c:3647@"range"`), `select` (`src/tychoc.c:3189-3225`),
> value-control routing (`src/tychoc.c:3420@parse_value_ctrl`,
> `src/tychoc.c:3740@parse_value_ctrl`, `src/tychoc.c:3754@parse_value_ctrl`,
> `src/tychoc.c:3740@parse_value_ctrl`, `src/tychoc.c:3785@parse_value_ctrl`).
