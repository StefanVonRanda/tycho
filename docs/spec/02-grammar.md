...
> Provenance: parser entry `src/tychoc.c:4538-4563` (`parse_program`); the
...
> Provenance: `parse_package_decl` `src/tychoc.c:4694@parse_package_decl`, `parse_import_decl` `:4701@parse_import_decl`, `parse_const`
> (`src/tychoc.c:4519-4536`).
...
> Provenance: `parse_fn`, `src/tychoc.c:3776-3886` (params `:3799-3824`,
> variadic-last `:3826-3828`, `where` `:3840-3878`).
...
> Provenance: `parse_extern_fn` (`src/tychoc.c:4026-4101`), `parse_subscript`
> (`:3906-3958`).
...
> Provenance: `parse_type_inner`, `src/tychoc.c:1960-2227`.
...
> Provenance: `parse_stmt`, `src/tychoc.c:3247-3727`; `ExprStmt` restriction
> `:3715-3722`; compound-assign hoist `:3209-3245`.
...
> Provenance: `parse_if` (`src/tychoc.c:3163@parse_if`), `parse_match`
> (`src/tychoc.c:3269@parse_match`, value form `src/tychoc.c:3394@parse_match`),
> `for`/`parallel` (`src/tychoc.c:3374-3585`; the three-clause header
> `src/tychoc.c:3418-3467`, `0..<N` `src/tychoc.c:3490-3515`, the `range`
> refusal `src/tychoc.c:3875@"range"`), `select` (`src/tychoc.c:3328-3364`),
> value-control routing (`src/tychoc.c:3648@parse_value_ctrl`,
> `src/tychoc.c:3968@parse_value_ctrl`, `src/tychoc.c:3982@parse_value_ctrl`,
> `src/tychoc.c:3968@parse_value_ctrl`, `src/tychoc.c:4013@parse_value_ctrl`).
...
> Provenance: precedence chain `src/tychoc.c:2743-2811`; postfix `:2603-2692`;
> `parse_primary` `:2312-2600`; unary `:2700-2706`.
...
> `parse_expr`, `src/tychoc.c:2743-2811`; postfix/unary `:2603-2706`.
