...
> Provenance: parser entry `src/tychoc.c:4423-4440` (`parse_program`); the
...
> Provenance: `parse_package_decl` `src/tychoc.c:4643@parse_package_decl`, `parse_import_decl` `:4650@parse_import_decl`, `parse_const`
> (`src/tychoc.c:4404-4421`).
...
> Provenance: `parse_fn`, `src/tychoc.c:3693-3785` (params `:4030-4069`,
> variadic-last `:4056-4058`, `where` `:3748-3777`).
...
> Provenance: `parse_extern_fn` (`src/tychoc.c:3920-3991`), `parse_subscript`
> (`:3805-3857`).
...
> Provenance: `parse_type_inner`, `src/tychoc.c:1797-2097`.
...
> Provenance: `parse_stmt`, `src/tychoc.c:3178-3660`; `ExprStmt` restriction
> `:3639-3646`; compound-assign hoist `:3140-3176`.
...
> Provenance: `parse_if` (`src/tychoc.c:3094@parse_if`), `parse_match`
> (`src/tychoc.c:3200@parse_match`, value form `src/tychoc.c:3325@parse_match`),
> `for`/`parallel` (`src/tychoc.c:3305-3497`; the three-clause header
> `src/tychoc.c:3349-3394`, `0..<N` `src/tychoc.c:3689-3714`, the `range`
> refusal `src/tychoc.c:3774@"range"`), `select` (`src/tychoc.c:3259-3295`),
> value-control routing (`src/tychoc.c:3572@parse_value_ctrl`,
> `src/tychoc.c:3867@parse_value_ctrl`, `src/tychoc.c:3881@parse_value_ctrl`,
> `src/tychoc.c:3867@parse_value_ctrl`, `src/tychoc.c:3912@parse_value_ctrl`).
...
> Provenance: precedence chain `src/tychoc.c:2647-2715`; postfix `:2492-2570`;
> `parse_primary` `:2195-2489`; unary `:2578-2584`.
...
> `parse_expr`, `src/tychoc.c:2647-2715`; postfix/unary `:2492-2584`.
