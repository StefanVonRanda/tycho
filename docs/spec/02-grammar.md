...
> Provenance: parser entry `src/tychoc.c:4416-4433` (`parse_program`); the
...
> Provenance: `parse_fn`, `src/tychoc.c:3686-3778` (params `:4023-4062`,
> variadic-last `:4049-4051`, `where` `:3741-3770`).
...
> Provenance: `parse_extern_fn` (`src/tychoc.c:3913-3984`), `parse_subscript`
> (`:3798-3850`).
...
> Provenance: `parse_type_inner`, `src/tychoc.c:1797-2095`.
...
> Provenance: `parse_stmt`, `src/tychoc.c:3171-3653`; `ExprStmt` restriction
> `:3632-3639`; compound-assign hoist `:3133-3169`.
...
> Provenance: `parse_if` (`src/tychoc.c:3087@parse_if`), `parse_match`
> (`src/tychoc.c:3193@parse_match`, value form `src/tychoc.c:3318@parse_match`),
> `for`/`parallel` (`src/tychoc.c:3298-3490`; the three-clause header
> `src/tychoc.c:3342-3387`, `0..<N` `src/tychoc.c:3682-3707`, the `range`
> refusal `src/tychoc.c:3767@"range"`), `select` (`src/tychoc.c:3252-3288`),
> value-control routing (`src/tychoc.c:3565@parse_value_ctrl`,
> `src/tychoc.c:3860@parse_value_ctrl`, `src/tychoc.c:3874@parse_value_ctrl`,
> `src/tychoc.c:3860@parse_value_ctrl`, `src/tychoc.c:3905@parse_value_ctrl`).
...
> Provenance: precedence chain `src/tychoc.c:2640-2708`; postfix `:2485-2563`;
> `parse_primary` `:2193-2482`; unary `:2571-2577`.
...
> `parse_expr`, `src/tychoc.c:2640-2708`; postfix/unary `:2485-2577`.
