...
> Provenance: parser entry `src/tychoc.c:4653-4670` (`parse_program`); the
...
> Provenance: `parse_package_decl` `src/tychoc.c:4882@parse_package_decl`, `parse_import_decl` `:4889@parse_import_decl`, `parse_const`
> (`src/tychoc.c:4632-4651`).
...
> Provenance: `parse_fn`, `src/tychoc.c:4024-4116` (params `:4361-4400`,
> variadic-last `:4387-4389`, `where` `:4079-4108`).
...
> Provenance: `parse_extern_fn` (`src/tychoc.c:4148-4219`), `parse_subscript`
> (`:4135-4187`).
...
> Provenance: `parse_type_inner`, `src/tychoc.c:1997-2298`.
...
> Provenance: `parse_stmt`, `src/tychoc.c:3400-3888`; `ExprStmt` restriction
> `:3970-3977`; compound-assign hoist `:3465-3507`.
...
> Provenance: `parse_if` (`src/tychoc.c:3316@parse_if`), `parse_match`
> (`src/tychoc.c:3422@parse_match`, value form `src/tychoc.c:3553@parse_match`),
> `for`/`parallel` (`src/tychoc.c:3533-3725`; the three-clause header
> `src/tychoc.c:3577-3622`, `0..<N` `src/tychoc.c:3917-3942`, the `range`
> refusal `src/tychoc.c:4002@"range"`), `select` (`src/tychoc.c:3487-3523`),
> value-control routing (`src/tychoc.c:3800@parse_value_ctrl`,
> `src/tychoc.c:4095@parse_value_ctrl`, `src/tychoc.c:4109@parse_value_ctrl`,
> `src/tychoc.c:4095@parse_value_ctrl`, `src/tychoc.c:4140@parse_value_ctrl`).
...
> Provenance: precedence chain `src/tychoc.c:2972-3040`; postfix `:2817-2895`;
> `parse_primary` `:2512-2814`; unary `:2903-2909`.
...
> `parse_expr`, `src/tychoc.c:2972-3040`; postfix/unary `:2817-2909`.
