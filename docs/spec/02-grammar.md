...
> Provenance: parser entry `src/tychoc.c:4693-4718` (`parse_program`); the
...
> Provenance: `parse_package_decl` `src/tychoc.c:4920@parse_package_decl`, `parse_import_decl` `:4927@parse_import_decl`, `parse_const`
> (`src/tychoc.c:4674-4691`).
...
> Provenance: `parse_fn`, `src/tychoc.c:3911-4035` (params `:3934-3973`,
> variadic-last `:3975-3977`, `where` `:3989-4027`).
...
> Provenance: `parse_extern_fn` (`src/tychoc.c:4175-4250`), `parse_subscript`
> (`:4055-4107`).
...
> Provenance: `parse_stmt`, `src/tychoc.c:3350-3861`; `ExprStmt` restriction
> `:3833-3840`; compound-assign hoist `:3312-3348`.
...
> Provenance: `parse_if` (`src/tychoc.c:3266@parse_if`), `parse_match`
> (`src/tychoc.c:3372@parse_match`, value form `src/tychoc.c:3497@parse_match`),
> `for`/`parallel` (`src/tychoc.c:3477-3688`; the three-clause header
> `src/tychoc.c:3521-3570`, `0..<N` `src/tychoc.c:3593-3618`, the `range`
> refusal `src/tychoc.c:4024@"range"`), `select` (`src/tychoc.c:3431-3467`),
> value-control routing (`src/tychoc.c:3766@parse_value_ctrl`,
> `src/tychoc.c:4117@parse_value_ctrl`, `src/tychoc.c:4131@parse_value_ctrl`,
> `src/tychoc.c:4117@parse_value_ctrl`, `src/tychoc.c:4162@parse_value_ctrl`).
...
> Provenance: precedence chain `src/tychoc.c:2846-2914`; postfix `:2687-2776`;
...
> `parse_expr`, `src/tychoc.c:2846-2914`; postfix/unary `:2687-2790`.
