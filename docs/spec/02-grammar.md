...
> Provenance: parser entry `src/tychoc.c:4572-4597` (`parse_program`); the
...
> Provenance: `parse_package_decl` `src/tychoc.c:4728@parse_package_decl`, `parse_import_decl` `:4735@parse_import_decl`, `parse_const`
> (`src/tychoc.c:4553-4570`).
...
> Provenance: `parse_fn`, `src/tychoc.c:3795-3905` (params `:3818-3843`,
> variadic-last `:3845-3847`, `where` `:3859-3897`).
...
> Provenance: `parse_extern_fn` (`src/tychoc.c:4045-4120`), `parse_subscript`
> (`:3925-3977`).
...
> Provenance: `parse_type_inner`, `src/tychoc.c:1964-2246`.
...
> Provenance: `parse_stmt`, `src/tychoc.c:3266-3746`; `ExprStmt` restriction
> `:3734-3741`; compound-assign hoist `:3228-3264`.
...
> Provenance: `parse_if` (`src/tychoc.c:3182@parse_if`), `parse_match`
> (`src/tychoc.c:3288@parse_match`, value form `src/tychoc.c:3413@parse_match`),
> `for`/`parallel` (`src/tychoc.c:3393-3604`; the three-clause header
> `src/tychoc.c:3437-3486`, `0..<N` `src/tychoc.c:3509-3534`, the `range`
> refusal `src/tychoc.c:3894@"range"`), `select` (`src/tychoc.c:3347-3383`),
> value-control routing (`src/tychoc.c:3667@parse_value_ctrl`,
> `src/tychoc.c:3987@parse_value_ctrl`, `src/tychoc.c:4001@parse_value_ctrl`,
> `src/tychoc.c:3987@parse_value_ctrl`, `src/tychoc.c:4032@parse_value_ctrl`).
...
> Provenance: precedence chain `src/tychoc.c:2762-2830`; postfix `:2622-2711`;
> `parse_primary` `:2331-2619`; unary `:2719-2725`.
...
> `parse_expr`, `src/tychoc.c:2762-2830`; postfix/unary `:2622-2725`.
