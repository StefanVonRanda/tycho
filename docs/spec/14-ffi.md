...
> Provenance: `docs/reference/ffi.md`; `parse_extern_fn` `src/tychoc.c:3877-3947`;
> boundary copy routines `runtime/tycho_rt.c:982-998`,`:1397@tycho_arr_int_from_c`,`:1387-1392`; typed handles
