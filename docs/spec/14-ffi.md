...
> Provenance: `docs/reference/ffi.md`; `parse_extern_fn` `src/tychoc.c:4148-4219`;
> boundary copy routines `runtime/tycho_rt.c:1129-1165`,`:1701@tycho_arr_int_from_c`,`:1682-1693`.
