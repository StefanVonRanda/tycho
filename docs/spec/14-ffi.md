...
> Provenance: `docs/reference/ffi.md`; `parse_extern_fn` `src/tychoc.c@parse_extern_fn`;
> boundary copy routines `runtime/tycho_rt.c:1287-1347`,`:1973@tycho_arr_int_from_c`,`:1991-2002`.
