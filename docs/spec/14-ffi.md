...
> Provenance: `docs/reference/ffi.md`; `parse_extern_fn` `src/tychoc.c:4138-4213`;
> boundary copy routines `runtime/tycho_rt.c:1122-1134`,`:1727@tycho_arr_int_from_c`,`:1518-1529`.
