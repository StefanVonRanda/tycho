...
> Provenance: `docs/reference/ffi.md`; `parse_extern_fn` `src/tychoc.c:4264-4339`;
> boundary copy routines `runtime/tycho_rt.c:1194-1206`,`:1821@tycho_arr_int_from_c`,`:1590-1601`.
