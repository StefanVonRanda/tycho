...
> Provenance: `docs/reference/ffi.md`; `parse_extern_fn` `src/tychoc.c:4161-4232`;
> boundary copy routines `runtime/tycho_rt.c:1275-1335`,`:1891@tycho_arr_int_from_c`,`:1912-1923`.
