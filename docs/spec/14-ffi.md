...
> Provenance: `docs/reference/ffi.md`; `parse_extern_fn` `src/tychoc.c:3921-3992`;
> boundary copy routines `runtime/tycho_rt.c:1097-1109`,`:1620@tycho_arr_int_from_c`,`:1601-1612`.
