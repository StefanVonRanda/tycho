...
> Provenance: `tycho_idiv`/`imod` `runtime/tycho_rt.c:85-94`, bounds
> `:1373-1379`,`:1044-1051`, `pop` `:1293-1297`, `substr` `:1065-1075`, string
> header `:969-987`, map hashing `:1913-1916`, channels/tasks `:577-956`.
