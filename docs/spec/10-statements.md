...
> the post clause resolved outside the body block `src/tychoc.c:7369-7374`;
> `continue` emitted as `goto _post<id>` `src/tychoc.c:10870-10873` with the
> label at `src/tychoc.c:11737@_post%d`; the `range()` refusal
