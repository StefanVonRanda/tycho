...
> the post clause resolved outside the body block `src/tychoc.c:7468-7473`;
> `continue` emitted as `goto _post<id>` `src/tychoc.c:11020-11023` with the
> label at `src/tychoc.c:11887@_post%d`; the `range()` refusal
