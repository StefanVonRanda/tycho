...
> the post clause resolved outside the body block `src/tychoc.c:7527-7532`;
> `continue` emitted as `goto _post<id>` `src/tychoc.c:11081-11084` with the
> label at `src/tychoc.c:11948@_post%d`; the `range()` refusal
