...
> the post clause resolved outside the body block `src/tychoc.c:8536-8541`;
> `continue` emitted as `goto _post<id>` `src/tychoc.c:12077-12080` with the
> label at `src/tychoc.c:12989@_post%d`; the `range()` refusal
