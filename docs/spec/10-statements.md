...
> the post clause resolved outside the body block `src/tychoc.c:7962-7967`;
> `continue` emitted as `goto _post<id>` `src/tychoc.c:11410-11413` with the
> label at `src/tychoc.c:12249@_post%d`; the `range()` refusal
