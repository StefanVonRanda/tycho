...
> the post clause resolved outside the body block `src/tychoc.c:7444-7449`;
> `continue` emitted as `goto _post<id>` `src/tychoc.c:10974-10977` with the
> label at `src/tychoc.c:11841@_post%d`; the `range()` refusal
