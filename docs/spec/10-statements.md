...
> the post clause resolved outside the body block `src/tychoc.c:7874-7879`;
> `continue` emitted as `goto _post<id>` `src/tychoc.c:11513-11516` with the
> label at `src/tychoc.c:12388@_post%d`; the `range()` refusal
