...
> the post clause resolved outside the body block `src/tychoc.c:8587-8592`;
> `continue` emitted as `goto _post<id>` `src/tychoc.c:12133-12136` with the
> label at `src/tychoc.c:13045@_post%d`; the `range()` refusal
