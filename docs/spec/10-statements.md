...
> the post clause resolved outside the body block `src/tychoc.c:7882-7887`;
> `continue` emitted as `goto _post<id>` `src/tychoc.c:11521-11524` with the
> label at `src/tychoc.c:12396@_post%d`; the `range()` refusal
