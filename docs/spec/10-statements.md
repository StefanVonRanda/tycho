...
> the post clause resolved outside the body block `src/tychoc.c:7524-7529`;
> `continue` emitted as `goto _post<id>` `src/tychoc.c:11076-11079` with the
> label at `src/tychoc.c:11943@_post%d`; the `range()` refusal
