...
> the post clause resolved outside the body block `src/tychoc.c:7895-7900`;
> `continue` emitted as `goto _post<id>` `src/tychoc.c:11342-11345` with the
> label at `src/tychoc.c:12181@_post%d`; the `range()` refusal
