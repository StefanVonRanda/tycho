...
> the post clause resolved outside the body block `src/tychoc.c:7549-7554`;
> `continue` emitted as `goto _post<id>` `src/tychoc.c:11103-11106` with the
> label at `src/tychoc.c:11970@_post%d`; the `range()` refusal
