...
> the post clause resolved outside the body block `src/tychoc.c:7512-7517`;
> `continue` emitted as `goto _post<id>` `src/tychoc.c:11064-11067` with the
> label at `src/tychoc.c:11931@_post%d`; the `range()` refusal
