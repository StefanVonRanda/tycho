...
> the post clause resolved outside the body block `src/tychoc.c:7921-7926`;
> `continue` emitted as `goto _post<id>` `src/tychoc.c:11581-11584` with the
> label at `src/tychoc.c:12456@_post%d`; the `range()` refusal
