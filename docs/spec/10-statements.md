...
> the post clause resolved outside the body block `src/tychoc.c:7988-7993`;
> `continue` emitted as `goto _post<id>` `src/tychoc.c:11653-11656` with the
> label at `src/tychoc.c:12528@_post%d`; the `range()` refusal
