...
> the post clause resolved outside the body block `src/tychoc.c:7875-7880`;
> `continue` emitted as `goto _post<id>` `src/tychoc.c:11322-11325` with the
> label at `src/tychoc.c:12161@_post%d`; the `range()` refusal
