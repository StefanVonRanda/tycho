...
> the post clause resolved outside the body block `src/tychoc.c:7750-7755`;
> `continue` emitted as `goto _post<id>` `src/tychoc.c:11341-11344` with the
> label at `src/tychoc.c:12216@_post%d`; the `range()` refusal
