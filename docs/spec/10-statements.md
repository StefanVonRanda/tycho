...
> the post clause resolved outside the body block `src/tychoc.c:7476-7481`;
> `continue` emitted as `goto _post<id>` `src/tychoc.c:11028-11031` with the
> label at `src/tychoc.c:11895@_post%d`; the `range()` refusal
