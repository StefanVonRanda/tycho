...
> Provenance: `instantiate_generic` `src/tychoc.c:8229-8334`; constraints
> `constraint_ok` `:8486-8495`, enforcement `:8540-8558`; parse `parse_fn`
> `:4079-4108`; type grammar for `$T`/`[$N]T` `:2102-2111`,`:2200-2224`.
