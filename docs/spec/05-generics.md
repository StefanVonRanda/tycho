...
> Provenance: `instantiate_generic` `src/tychoc.c:7750-7845`; constraints
> `constraint_ok` `:7721-7729`, enforcement `:7773-7790`; parse `parse_fn`
> `:3741-3770`; type grammar for `$T`/`[$N]T` `:1799-1808`,`:1894-1918`.
