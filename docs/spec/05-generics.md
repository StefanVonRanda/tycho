...
> Provenance: `instantiate_generic` `src/tychoc.c:8134-8239`; constraints
> `constraint_ok` `:8390-8399`, enforcement `:8444-8462`; parse `parse_fn`
> `:4027-4056`; type grammar for `$T`/`[$N]T` `:2056-2065`,`:2154-2178`.
