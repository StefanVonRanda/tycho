...
> Provenance: `instantiate_generic` `src/tychoc.c:7522-7612`; constraints
> `constraint_ok` `:7493-7501`, enforcement `:7545-7562`; parse `parse_fn`
> `:3711-3749`; type grammar for `$T`/`[$N]T` `:1898-1907`,`:1983-1999`.
