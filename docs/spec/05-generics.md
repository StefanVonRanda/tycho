...
> Provenance: `instantiate_generic` `src/tychoc.c:8123-8222`; constraints
> `constraint_ok` `:8094-8102`, enforcement `:8146-8163`; parse `parse_fn`
> `:4011-4049`; type grammar for `$T`/`[$N]T` `:2002-2011`,`:2103-2126`.
