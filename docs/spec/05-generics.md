...
> Provenance: `instantiate_generic` `src/tychoc.c:7645-7735`; constraints
> `constraint_ok` `:7616-7624`, enforcement `:7668-7685`; parse `parse_fn`
> `:3790-3828`; type grammar for `$T`/`[$N]T` `:1946-1955`,`:2031-2047`.
