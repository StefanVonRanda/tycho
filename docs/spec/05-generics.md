...
> Provenance: `instantiate_generic` `src/tychoc.c:7610-7700`; constraints
> `constraint_ok` `:7581-7589`, enforcement `:7633-7650`; parse `parse_fn`
> `:3768-3806`; type grammar for `$T`/`[$N]T` `:1945-1954`,`:2030-2046`.
