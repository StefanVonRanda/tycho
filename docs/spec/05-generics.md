...
> Provenance: `instantiate_generic` `src/tychoc.c:8444-8549`; constraints
> `constraint_ok` `:8701-8710`, enforcement `:8755-8773`; parse `parse_fn`
> `:4167-4196`; type grammar for `$T`/`[$N]T` `:2136-2145`,`:2234-2258`.
