...
> `constraint_ok` `src/tychoc.c@constraint_ok`, enforcement `src/tychoc.c:9079-9097`; the `where` clause
> `src/tychoc.c:4630@where`; type grammar for `$T`/`[$N]T`
> `src/tychoc.c:2158-2167`,`src/tychoc.c:2256-2280`.
