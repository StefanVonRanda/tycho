...
> `constraint_ok` `src/tychoc.c@constraint_ok`, enforcement `src/tychoc.c:8945-8963`; the `where` clause
> `src/tychoc.c:4568@where`; type grammar for `$T`/`[$N]T`
> `src/tychoc.c:2115-2124`,`src/tychoc.c:2213-2237`.
