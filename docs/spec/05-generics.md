...
> Provenance: `instantiate_generic` `src/tychoc.c:7917-8015`; constraints
> `constraint_ok` `:8059-8068`, enforcement `:8113-8131`; parse `parse_fn`
> `:3795-3824`; type grammar for `$T`/`[$N]T` `:1846-1855`,`:1943-1967`.
