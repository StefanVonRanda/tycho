...
> Provenance: `instantiate_generic` `src/tychoc.c:8278-8383`; constraints
> `constraint_ok` `:8535-8544`, enforcement `:8589-8607`; parse `parse_fn`
> `:4097-4126`; type grammar for `$T`/`[$N]T` `:2120-2129`,`:2218-2242`.
