...
> Provenance: `instantiate_generic` `src/tychoc.c:7979-8084`; constraints
> `constraint_ok` `:8128-8137`, enforcement `:8182-8200`; parse `parse_fn`
> `:3827-3856`; type grammar for `$T`/`[$N]T` `:1875-1884`,`:1973-1997`.
