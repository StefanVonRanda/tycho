...
> Provenance: `instantiate_generic` `src/tychoc.c:8634-8739`; constraints
> `constraint_ok` `:8891-8900`, enforcement `:8945-8963`; parse `parse_fn`
> `:4261-4290`; type grammar for `$T`/`[$N]T` `:2115-2124`,`:2213-2237`.
