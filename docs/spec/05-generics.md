...
> Provenance: `instantiate_generic` `src/tychoc.c:7624-7714`; constraints
> `constraint_ok` `:7595-7603`, enforcement `:7647-7664`; parse `parse_fn`
> `:3782-3820`; type grammar for `$T`/`[$N]T` `:1945-1954`,`:2030-2046`.
