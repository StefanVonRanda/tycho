...
> Provenance: `instantiate_generic` `src/tychoc.c:7842-7932`; constraints
> `constraint_ok` `:7813-7821`, enforcement `:7865-7882`; parse `parse_fn`
> `:3859-3897`; type grammar for `$T`/`[$N]T` `:1966-1975`,`:2051-2074`.
