...
> Provenance: `instantiate_generic` `src/tychoc.c:7174-7264`; constraints
> `constraint_ok` `:7145-7153`, enforcement `:7197-7214`; parse `parse_fn`
> `:3521-3559`; type grammar for `$T`/`[$N]T` `:1844-1853`,`:1929-1945`.
