...
> Provenance: `instantiate_generic` `src/tychoc.c:8335-8440`; constraints
> `constraint_ok` `:8592-8601`, enforcement `:8646-8664`; parse `parse_fn`
> `:4124-4153`; type grammar for `$T`/`[$N]T` `:2121-2130`,`:2219-2243`.
