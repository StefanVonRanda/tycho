...
> Provenance: `instantiate_generic` `src/tychoc.c:7482-7572`; constraints
> `constraint_ok` `:7453-7461`, enforcement `:7505-7522`; parse `parse_fn`
> `:3691-3729`; type grammar for `$T`/`[$N]T` `:1898-1907`,`:1983-1999`.
