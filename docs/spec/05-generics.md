...
> Provenance: `instantiate_generic` `src/tychoc.c:8273-8378`; constraints
> `constraint_ok` `:8530-8539`, enforcement `:8584-8602`; parse `parse_fn`
> `:4092-4121`; type grammar for `$T`/`[$N]T` `:2115-2124`,`:2213-2237`.
