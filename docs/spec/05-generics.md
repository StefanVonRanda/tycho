...
> Provenance: `instantiate_generic` `src/tychoc.c:7732-7822`; constraints
> `constraint_ok` `:7703-7711`, enforcement `:7755-7772`; parse `parse_fn`
> `:3829-3867`; type grammar for `$T`/`[$N]T` `:1954-1963`,`:2039-2055`.
