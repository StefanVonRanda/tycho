...
> Provenance: `instantiate_generic` `src/tychoc.c:8422-8527`; constraints
> `constraint_ok` `:8679-8688`, enforcement `:8733-8751`; parse `parse_fn`
> `:4145-4174`; type grammar for `$T`/`[$N]T` `:2114-2123`,`:2212-2236`.
