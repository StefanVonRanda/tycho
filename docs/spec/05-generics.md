...
> Provenance: `instantiate_generic` `src/tychoc.c:7717-7807`; constraints
> `constraint_ok` `:7688-7696`, enforcement `:7740-7757`; parse `parse_fn`
> `:3822-3860`; type grammar for `$T`/`[$N]T` `:1947-1956`,`:2032-2048`.
