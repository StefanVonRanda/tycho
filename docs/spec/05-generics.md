...
> Provenance: `instantiate_generic` `src/tychoc.c:8194-8299`; constraints
> `constraint_ok` `:8451-8460`, enforcement `:8505-8523`; parse `parse_fn`
> `:4044-4073`; type grammar for `$T`/`[$N]T` `:2067-2076`,`:2165-2189`.
