...
> Provenance: `instantiate_generic` `src/tychoc.c:8107-8212`; constraints
> `constraint_ok` `:8363-8372`, enforcement `:8417-8435`; parse `parse_fn`
> `:4008-4037`; type grammar for `$T`/`[$N]T` `:2056-2065`,`:2154-2178`.
