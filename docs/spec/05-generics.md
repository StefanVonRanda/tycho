...
> Provenance: `instantiate_generic` `src/tychoc.c:7644-7734`; constraints
> `constraint_ok` `:7615-7623`, enforcement `:7667-7684`; parse `parse_fn`
> `:3789-3827`; type grammar for `$T`/`[$N]T` `:1945-1954`,`:2030-2046`.
