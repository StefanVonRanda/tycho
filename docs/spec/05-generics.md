...
> Provenance: `instantiate_generic` `src/tychoc.c:7996-8101`; constraints
> `constraint_ok` `:8145-8154`, enforcement `:8199-8217`; parse `parse_fn`
> `:3844-3873`; type grammar for `$T`/`[$N]T` `:1892-1901`,`:1990-2014`.
