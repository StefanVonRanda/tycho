...
> Provenance: `instantiate_generic` `src/tychoc.c:8233-8346`; constraints
> `constraint_ok` `:8204-8212`, enforcement `:8256-8273`; parse `parse_fn`
> `:4078-4116`; type grammar for `$T`/`[$N]T` `:2018-2027`,`:2119-2143`.
