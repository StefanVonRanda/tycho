...
> Provenance: `instantiate_generic` `src/tychoc.c:8194-8307`; constraints
> `constraint_ok` `:8165-8173`, enforcement `:8217-8234`; parse `parse_fn`
> `:4043-4081`; type grammar for `$T`/`[$N]T` `:2008-2017`,`:2109-2133`.
