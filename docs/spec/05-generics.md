...
> Provenance: `instantiate_generic` `src/tychoc.c:8473-8578`; constraints
> `constraint_ok` `:8730-8739`, enforcement `:8784-8802`; parse `parse_fn`
> `:4146-4175`; type grammar for `$T`/`[$N]T` `:2115-2124`,`:2213-2237`.
