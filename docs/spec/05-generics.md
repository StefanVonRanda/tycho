...
> Provenance: `instantiate_generic` `src/tychoc.c:8303-8408`; constraints
> `constraint_ok` `:8560-8569`, enforcement `:8614-8632`; parse `parse_fn`
> `:4122-4151`; type grammar for `$T`/`[$N]T` `:2120-2129`,`:2218-2242`.
