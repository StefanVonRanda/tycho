...
> Provenance: `instantiate_generic` `src/tychoc.c:7873-7971`; constraints
> `constraint_ok` `:8015-8024`, enforcement `:8069-8087`; parse `parse_fn`
> `:3751-3780`; type grammar for `$T`/`[$N]T` `:1802-1811`,`:1899-1923`.
