...
> Provenance: `instantiate_generic` `src/tychoc.c:8431-8536`; constraints
> `constraint_ok` `:8688-8697`, enforcement `:8742-8760`; parse `parse_fn`
> `:4161-4190`; type grammar for `$T`/`[$N]T` `:2130-2139`,`:2228-2252`.
