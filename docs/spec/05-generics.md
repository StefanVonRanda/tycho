...
> Provenance: `instantiate_generic` `src/tychoc.c:7775-7870`; constraints
> `constraint_ok` `:7746-7754`, enforcement `:7798-7815`; parse `parse_fn`
> `:3748-3777`; type grammar for `$T`/`[$N]T` `:1799-1808`,`:1896-1920`.
