...
> Provenance: `instantiate_generic` `src/tychoc.c:8208-8321`; constraints
> `constraint_ok` `:8179-8187`, enforcement `:8231-8248`; parse `parse_fn`
> `:4053-4091`; type grammar for `$T`/`[$N]T` `:2018-2027`,`:2119-2143`.
