...
> Provenance: `instantiate_generic` `src/tychoc.c:8119-8224`; constraints
> `constraint_ok` `:8375-8384`, enforcement `:8429-8447`; parse `parse_fn`
> `:4020-4049`; type grammar for `$T`/`[$N]T` `:2056-2065`,`:2154-2178`.
