...
> Provenance: `instantiate_generic` `src/tychoc.c:8131-8230`; constraints
> `constraint_ok` `:8102-8110`, enforcement `:8154-8171`; parse `parse_fn`
> `:4017-4055`; type grammar for `$T`/`[$N]T` `:2008-2017`,`:2109-2132`.
