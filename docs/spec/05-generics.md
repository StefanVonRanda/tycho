...
> Provenance: `instantiate_generic` `src/tychoc.c:7537-7627`; constraints
> `constraint_ok` `:7508-7516`, enforcement `:7560-7577`; parse `parse_fn`
> `:3722-3760`; type grammar for `$T`/`[$N]T` `:1899-1908`,`:1984-2000`.
