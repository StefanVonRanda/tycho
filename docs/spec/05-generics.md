...
> Provenance: `instantiate_generic` `src/tychoc.c:8068-8173`; constraints
> `constraint_ok` `:8217-8226`, enforcement `:8271-8289`; parse `parse_fn`
> `:3882-3911`; type grammar for `$T`/`[$N]T` `:1930-1939`,`:2028-2052`.
