...
> Provenance: `instantiate_generic` `src/tychoc.c:7864-7954`; constraints
> `constraint_ok` `:7835-7843`, enforcement `:7887-7904`; parse `parse_fn`
> `:3890-3928`; type grammar for `$T`/`[$N]T` `:1966-1975`,`:2067-2090`.
