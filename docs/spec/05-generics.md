...
> Provenance: `instantiate_generic` `src/tychoc.c:8547-8652`; constraints
> `constraint_ok` `:8804-8813`, enforcement `:8858-8876`; parse `parse_fn`
> `:4177-4206`; type grammar for `$T`/`[$N]T` `:2115-2124`,`:2213-2237`.
