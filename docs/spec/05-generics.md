...
> Provenance: `instantiate_generic` `src/tychoc.c:7970-8060`; constraints
> `constraint_ok` `:7941-7949`, enforcement `:7993-8010`; parse `parse_fn`
> `:3925-3963`; type grammar for `$T`/`[$N]T` `:1988-1997`,`:2089-2112`.
