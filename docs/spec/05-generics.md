...
> Provenance: `instantiate_generic` `src/tychoc.c:7886-7976`; constraints
> `constraint_ok` `:7857-7865`, enforcement `:7909-7926`; parse `parse_fn`
> `:3912-3950`; type grammar for `$T`/`[$N]T` `:1988-1997`,`:2089-2112`.
