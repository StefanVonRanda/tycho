...
> Provenance: `instantiate_generic` `src/tychoc.c:7685-7775`; constraints
> `constraint_ok` `:7656-7664`, enforcement `:7708-7725`; parse `parse_fn`
> `:3817-3855`; type grammar for `$T`/`[$N]T` `:1947-1956`,`:2032-2048`.
