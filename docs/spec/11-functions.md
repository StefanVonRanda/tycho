...
> Provenance: `parse_fn` `src/tychoc.c:3694-3786`; parameter modes and the
...
many there may be (`src/tychoc.c:8813@parameters`, ahead of the template stash; locked by
