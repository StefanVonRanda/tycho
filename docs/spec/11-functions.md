...
> Provenance: `parse_fn` `src/tychoc.c:3954-4078`; parameter modes and the
...
many there may be (`src/tychoc.c:9187@parameters`, ahead of the template stash; locked by
