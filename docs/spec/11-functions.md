...
> Provenance: `parse_fn` `src/tychoc.c:3795-3905`; parameter modes and the
...
many there may be (`src/tychoc.c:8816@parameters`, ahead of the template stash; locked by
