...
> Provenance: `parse_fn` `src/tychoc.c:3869-3961`; parameter modes and the
...
many there may be (`src/tychoc.c:9105@parameters`, ahead of the template stash; locked by
