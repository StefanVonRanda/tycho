...
> Provenance: `parse_fn` `src/tychoc.c:3965-4089`; parameter modes and the
...
many there may be (`src/tychoc.c:9201@parameters`, ahead of the template stash; locked by
