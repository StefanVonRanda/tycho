...
> Provenance: `parse_fn` `src/tychoc.c:3892-4016`; parameter modes and the
...
many there may be (`src/tychoc.c:9020@parameters`, ahead of the template stash; locked by
