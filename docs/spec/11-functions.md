...
> Provenance: `parse_fn` `src/tychoc.c:3765-3875`; parameter modes and the
...
many there may be (`src/tychoc.c:8688@parameters`, ahead of the template stash; locked by
