...
> Provenance: `parse_fn` `src/tychoc.c:3875-3967`; parameter modes and the
...
many there may be (`src/tychoc.c:9117@parameters`, ahead of the template stash; locked by
