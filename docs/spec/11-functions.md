...
> Provenance: `parse_fn` `src/tychoc.c:3848-3958`; parameter modes and the
...
many there may be (`src/tychoc.c:8860@parameters`, ahead of the template stash; locked by
