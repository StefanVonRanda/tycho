...
> Provenance: `parse_fn` `src/tychoc.c:3987-4079`; parameter modes and the
...
many there may be (`src/tychoc.c:9440@parameters`, ahead of the template stash; locked by
