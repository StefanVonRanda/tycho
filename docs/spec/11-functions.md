...
> Provenance: `parse_fn` `src/tychoc.c:3825-3917`; parameter modes and the
...
many there may be (`src/tychoc.c:9039@parameters`, ahead of the template stash; locked by
