...
> Provenance: `parse_fn` `src/tychoc.c:3966-4058`; parameter modes and the
...
many there may be (`src/tychoc.c:9353@parameters`, ahead of the template stash; locked by
