...
> Provenance: `parse_fn` `src/tychoc.c:4095-4195`; parameter modes and the
...
many there may be (`src/tychoc.c:9652@parameters`, ahead of the template stash; locked by
