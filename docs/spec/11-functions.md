...
> Provenance: `parse_fn` `src/tychoc.c:3693-3785`; parameter modes and the
...
many there may be (`src/tychoc.c:8711@parameters`, ahead of the template stash; locked by
