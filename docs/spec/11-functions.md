...
> Provenance: `parse_fn` `src/tychoc.c:3770-3862`; parameter modes and the
...
many there may be (`src/tychoc.c:8926@parameters`, ahead of the template stash; locked by
