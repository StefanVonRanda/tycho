...
> Provenance: `parse_fn` `src/tychoc.c:3939-4031`; parameter modes and the
...
many there may be (`src/tychoc.c:9280@parameters`, ahead of the template stash; locked by
