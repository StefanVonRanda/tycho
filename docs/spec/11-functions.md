...
> Provenance: `parse_fn` `src/tychoc.c:3886-3978`; parameter modes and the
...
many there may be (`src/tychoc.c:9149@parameters`, ahead of the template stash; locked by
