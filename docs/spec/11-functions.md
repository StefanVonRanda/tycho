...
> Provenance: `parse_fn` `src/tychoc.c:3874-3984`; parameter modes and the
...
many there may be (`src/tychoc.c:8959@parameters`, ahead of the template stash; locked by
