...
> Provenance: `parse_fn` `src/tychoc.c:3862-3954`; parameter modes and the
...
many there may be (`src/tychoc.c:9098@parameters`, ahead of the template stash; locked by
