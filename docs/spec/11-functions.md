...
> Provenance: `parse_fn` `src/tychoc.c:4009-4101`; parameter modes and the
...
many there may be (`src/tychoc.c:9462@parameters`, ahead of the template stash; locked by
