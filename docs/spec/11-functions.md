...
> Provenance: `parse_fn` `src/tychoc.c:3861-3971`; parameter modes and the
...
many there may be (`src/tychoc.c:8944@parameters`, ahead of the template stash; locked by
