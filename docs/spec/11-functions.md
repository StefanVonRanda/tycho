...
> Provenance: `parse_fn` `src/tychoc.c:3788-3898`; parameter modes and the
...
many there may be (`src/tychoc.c:8792@parameters`, ahead of the template stash; locked by
