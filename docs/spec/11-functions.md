...
> Provenance: `parse_fn` `src/tychoc.c:3738-3830`; parameter modes and the
...
many there may be (`src/tychoc.c:8857@parameters`, ahead of the template stash; locked by
