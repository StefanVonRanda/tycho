...
> Provenance: `parse_fn` `src/tychoc.c:4000-4124`; parameter modes and the
...
many there may be (`src/tychoc.c:9272@parameters`, ahead of the template stash; locked by
