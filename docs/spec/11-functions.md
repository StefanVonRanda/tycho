...
> Provenance: `parse_fn` `src/tychoc.c:3773-3883`; parameter modes and the
...
many there may be (`src/tychoc.c:8729@parameters`, ahead of the template stash; locked by
