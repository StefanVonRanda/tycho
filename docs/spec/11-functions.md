...
> Provenance: `parse_fn` `src/tychoc.c:4003-4095`; parameter modes and the
...
many there may be (`src/tychoc.c:9449@parameters`, ahead of the template stash; locked by
