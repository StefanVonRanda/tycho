...
> Provenance: `parse_fn` `src/tychoc.c:3934-4026`; parameter modes and the
...
many there may be (`src/tychoc.c:9275@parameters`, ahead of the template stash; locked by
