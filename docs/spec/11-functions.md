...
> Provenance: `parse_fn` `src/tychoc.c:3686-3778`; parameter modes and the
...
many there may be (`src/tychoc.c:8686@parameters`, ahead of the template stash; locked by
