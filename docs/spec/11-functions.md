...
> Provenance: `parse_fn` `src/tychoc.c:3874-3998`; parameter modes and the
...
many there may be (`src/tychoc.c:8973@parameters`, ahead of the template stash; locked by
