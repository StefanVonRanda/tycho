...
> Provenance: `parse_fn` `src/tychoc.c:3776-3886`; parameter modes and the
...
many there may be (`src/tychoc.c:8734@parameters`, ahead of the template stash; locked by
