...
> Provenance: `parse_fn` `src/tychoc.c:3964-4056`; parameter modes and the
...
many there may be (`src/tychoc.c:9321@parameters`, ahead of the template stash; locked by
