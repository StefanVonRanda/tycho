...
> Provenance: `parse_fn` `src/tychoc.c:3826-3936`; parameter modes and the
...
many there may be (`src/tychoc.c:8838@parameters`, ahead of the template stash; locked by
