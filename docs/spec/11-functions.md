...
> Provenance: `parse_fn` `src/tychoc.c:3787-3879`; parameter modes and the
...
many there may be (`src/tychoc.c:9001@parameters`, ahead of the template stash; locked by
