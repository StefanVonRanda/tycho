...
> Provenance: `parse_fn` `src/tychoc.c:3939-4063`; parameter modes and the
...
many there may be (`src/tychoc.c:9168@parameters`, ahead of the template stash; locked by
