...
> Provenance: `parse_fn` `src/tychoc.c:3850-3942`; parameter modes and the
...
many there may be (`src/tychoc.c:9078@parameters`, ahead of the template stash; locked by
