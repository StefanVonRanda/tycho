...
arena" string that defaults to `&_scope` (`src/tychoc.c:9326@g_cur_scope`) and a
...
in, and the compiler already picks that per write site (`src/tychoc.c:9326@g_cur_scope`,
