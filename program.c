...
char *h_greet(Arena *_parent, char *h_name) {
    Arena _scope = arena_child(_parent); _scope.name = "greet";
#line 4 "/home/igzo/github/tycho/examples/hello.ty"
    { char *_ret = tycho_str_concat(_parent, TYCHO_LIT("hello "), h_name); arena_free(&_scope); return _ret; }
}

void h_main(Arena *_parent) {
    Arena _scope = arena_child(_parent); _scope.name = "main";
#line 7 "/home/igzo/github/tycho/examples/hello.ty"
    { Arena _t = arena_new(0); tycho_print_s(TYCHO_LIT("what is your name: ")); arena_free(&_t); }
#line 8 "/home/igzo/github/tycho/examples/hello.ty"
    char *h_name = tycho_input(&_scope);
#line 9 "/home/igzo/github/tycho/examples/hello.ty"
    { Arena _t = arena_new(0); (tycho_print_s(h_greet(&_t, h_name)), tycho_print("\n")); arena_free(&_t); }
    arena_free(&_scope);
}
