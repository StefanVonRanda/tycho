...
**Minimal repro**
The smallest `.ty` program that triggers it (paste it inline — this is the single
...
How you compiled/ran it (e.g. `./tychoc bug.ty && ./bug`, or `make ci`):
...
- Tycho commit / tag: (`git rev-parse --short HEAD` or the release tag)
