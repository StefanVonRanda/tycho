...
const char *fz_echo(const char *s)     { return s; }                          /* str arg + str return (hier arena-copies) */
const char *fz_nullify(const char *s)  { return (s && *s) ? s : 0; }          /* NULL return -> hier guards to "" */
