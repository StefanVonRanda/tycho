...
# is kept only as a fail-closed assertion (src/tychoc.c:7663@r_step). The constraint that
...
# (src/tychoc.c:7562-7565), so this fixture's original body `a, b = b, a` was never
