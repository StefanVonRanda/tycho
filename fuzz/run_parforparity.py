...
# is kept only as a fail-closed assertion (src/tychoc.c:7456@r_step). The constraint that
...
# (src/tychoc.c:7355-7358), so this fixture's original body `a, b = b, a` was never
