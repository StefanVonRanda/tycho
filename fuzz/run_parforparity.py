...
# is kept only as a fail-closed assertion (src/tychoc.c:7276@r_step). The constraint that
...
# (src/tychoc.c:7175-7178), so this fixture's original body `a, b = b, a` was never
