...
# is kept only as a fail-closed assertion (src/tychoc.c:7375@r_step). The constraint that
...
# (src/tychoc.c:7274-7277), so this fixture's original body `a, b = b, a` was never
