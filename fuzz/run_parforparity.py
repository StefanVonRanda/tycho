...
# is kept only as a fail-closed assertion (src/tychoc.c:7351@r_step). The constraint that
...
# (src/tychoc.c:7250-7253), so this fixture's original body `a, b = b, a` was never
