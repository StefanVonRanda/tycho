...
# is kept only as a fail-closed assertion (src/tychoc.c:7852@r_step). The constraint that
...
# (src/tychoc.c:7741-7744), so this fixture's original body `a, b = b, a` was never
