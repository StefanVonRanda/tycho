...
# is kept only as a fail-closed assertion (src/tychoc.c:7466@r_step). The constraint that
...
# (src/tychoc.c:7365-7368), so this fixture's original body `a, b = b, a` was never
