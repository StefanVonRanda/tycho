...
# is kept only as a fail-closed assertion (src/tychoc.c:7425@r_step). The constraint that
...
# (src/tychoc.c:7324-7327), so this fixture's original body `a, b = b, a` was never
