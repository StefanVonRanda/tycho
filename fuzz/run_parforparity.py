...
# is kept only as a fail-closed assertion (src/tychoc.c:7419@r_step). The constraint that
...
# (src/tychoc.c:7318-7321), so this fixture's original body `a, b = b, a` was never
