...
# is kept only as a fail-closed assertion (src/tychoc.c:7398@r_step). The constraint that
...
# (src/tychoc.c:7297-7300), so this fixture's original body `a, b = b, a` was never
