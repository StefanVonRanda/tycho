...
# is kept only as a fail-closed assertion (src/tychoc.c:7781@r_step). The constraint that
...
# (src/tychoc.c:7670-7673), so this fixture's original body `a, b = b, a` was never
