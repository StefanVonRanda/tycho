...
# is kept only as a fail-closed assertion (src/tychoc.c:7500@r_step). The constraint that
...
# (src/tychoc.c:7399-7402), so this fixture's original body `a, b = b, a` was never
