...
# is kept only as a fail-closed assertion (src/tychoc.c:7367@r_step). The constraint that
...
# (src/tychoc.c:7266-7269), so this fixture's original body `a, b = b, a` was never
