...
#   Makefile:335@SKIPPED,:327  disable it for -m32 (32-bit ASan is absent under multilib)
...
#      same reason Makefile:335@SKIPPED skips it); and the emitted programs' own runtime
