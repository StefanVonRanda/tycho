...
#   Makefile:278@SKIPPED,:279  disable it for -m32 (32-bit ASan is absent under multilib)
...
#      same reason Makefile:278@SKIPPED skips it); and the emitted programs' own runtime
