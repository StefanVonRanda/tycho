...
# survived 16 phases of plan.md and a full 1.0 freeze (the front-door plan). It was
...
# string, every generic bind vector (`gi.binds`, src/tychoc.c:8482@gi.binds, xmalloc'd and
...
#      same reason Makefile@SKIPPED skips it); and the emitted programs' own runtime
