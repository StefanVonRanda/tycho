...
#   Makefile:253@SKIPPED,:246  disable it for -m32 (32-bit ASan is absent under multilib)
...
#      same reason Makefile:253@SKIPPED skips it); and the emitted programs' own runtime
