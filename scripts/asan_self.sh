...
#   Makefile:366@SKIPPED,:358  disable it for -m32 (32-bit ASan is absent under multilib)
...
#      same reason Makefile:366@SKIPPED skips it); and the emitted programs' own runtime
