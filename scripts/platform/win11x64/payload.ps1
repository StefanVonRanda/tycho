# The windows-x86_64 payload. Identical in shape to the arm64 one and for
# the same reason: Windows has no POSIX userland, and the guest only has to
# compile and run.
#
...
# lives here and the only install is a compiler.
#
