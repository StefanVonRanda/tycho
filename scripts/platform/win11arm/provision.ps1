# First-logon provisioning for the windows-arm64 platform leg.
...
Say 'provisioning windows-arm64 build agent'
...
# aarch64 Windows. llvm-mingw ships a NATIVE aarch64 clang that targets
# aarch64 Windows, so the binaries under test are the ones a user would get.
...
$tc  = 'llvm-mingw-20250910-ucrt-aarch64'
