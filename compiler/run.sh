...
[ "$nsyn" = 90 ] && [ "$nname" = 30 ] && [ "$ntype" = 147 ] && [ "$nsem" = 104 ] || { echo "parse-check: the split moved -- expected SYNTAX=90 NAME=30 TYPE=147 SEMANTIC=104"; rc=1; }
...
[ "$tr" = 367 ] || { echo "parse-check: --typecheck refused $tr of 371, expected 367"; rc=1; }
