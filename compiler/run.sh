...
[ "$nsyn" = 93 ] && [ "$nname" = 33 ] && [ "$ntype" = 164 ] && [ "$nsem" = 237 ] || { echo "parse-check: the split moved -- expected SYNTAX=93 NAME=33 TYPE=164 SEMANTIC=237"; rc=1; }
...
[ "$tr" = 523 ] || { echo "parse-check: --typecheck refused $tr of 527, expected 523"; rc=1; }
