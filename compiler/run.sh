...
[ "$nsyn" = 93 ] && [ "$nname" = 33 ] && [ "$ntype" = 164 ] && [ "$nsem" = 231 ] || { echo "parse-check: the split moved -- expected SYNTAX=93 NAME=33 TYPE=164 SEMANTIC=231"; rc=1; }
...
[ "$tr" = 517 ] || { echo "parse-check: --typecheck refused $tr of 521, expected 517"; rc=1; }
