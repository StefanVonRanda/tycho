...
[ "$nsyn" = 93 ] && [ "$nname" = 33 ] && [ "$ntype" = 161 ] && [ "$nsem" = 162 ] || { echo "parse-check: the split moved -- expected SYNTAX=93 NAME=33 TYPE=161 SEMANTIC=162"; rc=1; }
...
[ "$tr" = 445 ] || { echo "parse-check: --typecheck refused $tr of 449, expected 445"; rc=1; }
