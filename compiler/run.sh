...
[ "$nsyn" = 93 ] && [ "$nname" = 33 ] && [ "$ntype" = 164 ] && [ "$nsem" = 225 ] || { echo "parse-check: the split moved -- expected SYNTAX=93 NAME=33 TYPE=164 SEMANTIC=225"; rc=1; }
...
[ "$tr" = 511 ] || { echo "parse-check: --typecheck refused $tr of 515, expected 511"; rc=1; }
