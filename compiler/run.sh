...
# THROUGH a subscript, which is the `g.at(0) = 5` place form (src/tychoc.c:4406).
pr ok_subscript <<'EOF'
package main
struct G:
    xs: [int]
...
# is decoration until Phase 9 pins message text. src/tychoc.c:6672 answers
# `pkg.Name` written with NO call; src/tychoc.c:7031 answers `pkg.name(...)`.
