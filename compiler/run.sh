...
# leg1 289 -> 290: tests/inline_arr_reassign_loop.ty; -> 292: tests/or_else{,_frees}.ty (2026-09-25); leg1c 179 -> 180: tools/tycho-grade/main.ty (2026-09-24)
leg_accept "leg1  tests/*.ty" "$(ls tests/*.ty)" 292
