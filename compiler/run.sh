...
[ "$nsyn" = 93 ] && [ "$nname" = 30 ] && [ "$ntype" = 147 ] && [ "$nsem" = 104 ] || { echo "parse-check: the split moved -- expected SYNTAX=93 NAME=30 TYPE=147 SEMANTIC=104"; rc=1; }
...
[ "$tr" = 370 ] || { echo "parse-check: --typecheck refused $tr of 374, expected 370"; rc=1; }
