...
[ "$nsyn" = 93 ] && [ "$nname" = 33 ] && [ "$ntype" = 164 ] && [ "$nsem" = 186 ] || { echo "parse-check: the split moved -- expected SYNTAX=93 NAME=33 TYPE=164 SEMANTIC=186"; rc=1; }
...
[ "$tr" = 472 ] || { echo "parse-check: --typecheck refused $tr of 476, expected 472"; rc=1; }
