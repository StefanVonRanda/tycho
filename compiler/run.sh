...
[ "$nsyn" = 61 ] && [ "$nname" = 30 ] && [ "$ntype" = 147 ] && [ "$nsem" = 104 ] || { echo "parse-check: the split moved -- expected SYNTAX=61 NAME=30 TYPE=147 SEMANTIC=104"; rc=1; }
...
[ "$tr" = 338 ] || { echo "parse-check: --typecheck refused $tr of 342, expected 338"; rc=1; }
