...
[ "$nsyn" = 57 ] && [ "$nname" = 30 ] && [ "$ntype" = 147 ] && [ "$nsem" = 104 ] || { echo "parse-check: the split moved -- expected SYNTAX=57 NAME=30 TYPE=147 SEMANTIC=104"; rc=1; }
...
[ "$tr" = 334 ] || { echo "parse-check: --typecheck refused $tr of 338, expected 334"; rc=1; }
