...
#
#   [1]  every tests/*.ty that ./tychoc accepts must parse       276/276
...
[ "$n_acc" = 276 ] || { echo "parse-check: tests/*.ty is $n_acc, expected 276"; rc=1; }
...
leg_accept "leg1  tests/*.ty" "$(ls tests/*.ty)" 276
