...
[ "$nsyn" = 93 ] && [ "$nname" = 33 ] && [ "$ntype" = 164 ] && [ "$nsem" = 210 ] || { echo "parse-check: the split moved -- expected SYNTAX=93 NAME=33 TYPE=164 SEMANTIC=210"; rc=1; }
...
[ "$tr" = 496 ] || { echo "parse-check: --typecheck refused $tr of 500, expected 496"; rc=1; }
