...
[ "$nsyn" = 93 ] && [ "$nname" = 33 ] && [ "$ntype" = 161 ] && [ "$nsem" = 151 ] || { echo "parse-check: the split moved -- expected SYNTAX=93 NAME=33 TYPE=161 SEMANTIC=151"; rc=1; }
...
[ "$tr" = 434 ] || { echo "parse-check: --typecheck refused $tr of 438, expected 434"; rc=1; }
