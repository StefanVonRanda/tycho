...
SIXB = 7
EXPECT = 1375          # a leg that scores 0 of 0 is green by accident
...
# merge_pkg (src/tychoc.c:14766, :14234) names the offending FILE and exits. Both
...
# spawn legs (src/tychoc.c:6336-6347) and wait's argument (:6776) into
