...
EXPECT = 1311          # a leg that scores 0 of 0 is green by accident
...
# merge_pkg (src/tychoc.c:14262, :14234) names the offending FILE and exits. Both
...
KNOWN_TYPE_MISS = {
    ...
    # spawn legs (src/tychoc.c:6003-6014) and wait's argument (:6776) into
