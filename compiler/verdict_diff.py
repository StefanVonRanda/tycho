...
SIXB = 7
EXPECT = 1410          # a leg that scores 0 of 0 is green by accident
                       # 1406 -> 1407: tests/reject/value_if_nested.ty (2026-09-24); -> 1410: three handle use-after-close fixtures
