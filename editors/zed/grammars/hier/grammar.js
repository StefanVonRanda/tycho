// tree-sitter grammar for Hier — FLAT (token-level). It lexes a .hi file into a
...
// (hier-lsp) attaches for diagnostics. A full structural grammar would need a C
// external scanner for INDENT/DEDENT (hier is indentation-significant); this
