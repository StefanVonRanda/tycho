...
|---|---|---|
| Markdown, comments, a `path:line` citation, a commit hash in prose | `make check-links` | ~2s (measured 2026-08-15; check_citations alone is 1.4 s, up from 0.53 s). Also fails a NEW document under `docs/` that no index links to. Nothing else can tell you more — none of it reaches a compiled artifact |
