...
| a fixture under `docs/spec/`, or moved a `tests/` directory | `sh scripts/spec_check.sh` | ~9.6s. Also checks Appendix A against §3/§4, and that every `tests/…` path in Appendix E resolves |
