...
| `tools/tycho-agg/` | `make agg-check` | ~3s. The only program that DECLARES generics rather than consuming corelib's, and the only lane that asserts an instantiation reached codegen |
