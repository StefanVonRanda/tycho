#!/bin/sh
# corelib EXAMPLES harness. Each examples/corelib/<name>.hi is a small, readable
...
# C compiler (hierc), via `hierc --bundle | hierc0`, AND by standalone hierc0,
...
fail=0
for entry in examples/corelib/*/main.hi; do
    [ -e "$entry" ] || continue
