...
corpus_census() {
    ...
    # (src/tychoc.c:6433-7027), plus all 15 R21f-7 added for the 6k struct and
    # enum CONSTRUCTION block (src/tychoc.c:7089-7201), plus all 6 flat ones
    # R21f-8 added for the 6k field and variant ACCESS block
    # (src/tychoc.c:6514-6848; its other 3 are package fixtures and are not in
