...
corpus_census() {
    ...
    # 25 R21f added for the builtin-call block at src/tychoc.c:7226-7460, plus all
    # 21 R21f-2 added for src/tychoc.c:7467-8092, plus all 11 R21f-3 added for
    ...
    # (src/tychoc.c:6447-7041), plus all 15 R21f-7 added for the 6k struct and
    # enum CONSTRUCTION block (src/tychoc.c:7103-7215), plus all 6 flat ones
    # R21f-8 added for the 6k field and variant ACCESS block
    # (src/tychoc.c:6528-6862; its other 3 are package fixtures and are not in
    ...
    [ "$cc_exp" -eq 631 ] || cc_bad="$cc_bad reject-expect:$cc_exp!=631"   # +1: value_if_nested (2026-09-24); +3: handle use-after-close (2026-09-24); +1: handle_close_param (2026-09-24); +1: slice_struct (2026-09-25); +4: fixarr/vector pop and reserve (2026-09-25)
