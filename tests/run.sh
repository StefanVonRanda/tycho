...
corpus_census() {
    ...
    # 25 R21f added for the builtin-call block at src/tychoc.c:7190-7418, plus all
    # 21 R21f-2 added for src/tychoc.c:7425-8027, plus all 11 R21f-3 added for
    ...
    # (src/tychoc.c:6411-7005), plus all 15 R21f-7 added for the 6k struct and
    # enum CONSTRUCTION block (src/tychoc.c:7067-7179), plus all 6 flat ones
    # R21f-8 added for the 6k field and variant ACCESS block
    # (src/tychoc.c:6492-6826; its other 3 are package fixtures and are not in
