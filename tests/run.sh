...
corpus_census() {
    ...
    # still prints `ok`. So the count is pinned to a literal here. 171 = the 82 at
    ...
    # 21 R21f-2 added for src/tychoc.c:7004-7598.
    ...
    [ "$cc_exp" -eq 171 ] || cc_bad="$cc_bad reject-expect:$cc_exp!=171"
