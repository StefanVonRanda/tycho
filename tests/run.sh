...
corpus_census() {
    ...
    # still prints `ok`. So the count is pinned to a literal here. 150 = the 82 at
    ...
    # 25 R21f added for the builtin-call block at src/tychoc.c:6774-6997.
    ...
    [ "$cc_exp" -eq 150 ] || cc_bad="$cc_bad reject-expect:$cc_exp!=150"
