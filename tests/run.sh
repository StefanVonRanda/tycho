...
corpus_census() {
    ...
    # 25 R21f added for the builtin-call block at src/tychoc.c:7272-7506, plus all
    # 21 R21f-2 added for src/tychoc.c:7513-8142, plus all 11 R21f-3 added for
    ...
    # (src/tychoc.c:6466-7087), plus all 15 R21f-7 added for the 6k struct and
    # enum CONSTRUCTION block (src/tychoc.c:7149-7261), plus all 6 flat ones
    # R21f-8 added for the 6k field and variant ACCESS block
    # (src/tychoc.c:6547-6908; its other 3 are package fixtures and are not in
